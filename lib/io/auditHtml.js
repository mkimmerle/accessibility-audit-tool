              ...
              <a href="#rule-${rule.id}" class="priority-link">
                    <span class="priority-name">
                        <span class="rule__name--wrapper">
                            ${friendlyName}
                            ${rule.isSystemic ? `<span class="rule__badge rule__badge--systemic">SYSTEMIC</span>` : ''}
                        </span>
                    </span>
    ...
    <summary class="rule__summary">
        <span class="rule__title">
            <span class="rule__name--wrapper">
                ...
                ${rule.isSystemic ? `<span class="rule__badge rule__badge--systemic">GLOBAL COMPONENT ISSUE</span>` : ''}
            </span>
        </span>
