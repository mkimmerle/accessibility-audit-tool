 ...
 */
export function writeAuditHtml({ htmlPath, siteUrl, rules, priorityRules, fullyResolvedRules, diffTotals }) {
...
<main class="layout-container layout-container--wide results-shell">
    ...
    <section class="audit-summary-grid">
        <div class="summary-card">
            ...
            <span class="summary-value">${rules.length ? rules[0].occurrences.length : 0}</span>
        </div>
