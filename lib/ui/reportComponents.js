...
export const TrendChart = (history) => {
    ...
    const width = 1000;
    const height = 150;
    const paddingLeft = 40; // Space for the Y-axis "0" label

    // Utility: Format ISO date to localized M/D/YY
    ...
    const maxErrors = Math.max(...errorCounts, 10); 
    ...
    <section class="priority-callout chart-container">
        ...
        <div class="chart-wrapper">
            <svg viewBox="-10 -30 ${width + 20} ${height + 60}" aria-hidden="true" class="trend-svg">
